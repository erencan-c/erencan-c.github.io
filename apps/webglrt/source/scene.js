...
class Scene {
    ...
    send_scene(gl, shader) {
        gl.uniform3f(shader.getUniformLocation(gl, 'ambient_light'), this.ambient_light[0], this.ambient_light[1], this.ambient_light[2]);
        gl.uniform3f(shader.getUniformLocation(gl, 'background_color'), this.background_color[0], this.background_color[1], this.background_color[2]);
        gl.uniform3f(shader.getUniformLocation(gl, 'camera.gaze'), this.camera.gaze[0], this.camera.gaze[1], this.camera.gaze[2]);
        gl.uniform1f(shader.getUniformLocation(gl, 'camera.near_distance'), this.camera.near_distance);
        gl.uniform4f(shader.getUniformLocation(gl, 'camera.near_plane'), this.camera.near_plane[0], this.camera.near_plane[1], this.camera.near_plane[2], this.camera.near_plane[3]);
