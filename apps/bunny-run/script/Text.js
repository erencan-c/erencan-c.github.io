...
const [vao, vbo, ebo, vertexCount] = (() => {
    ...
    gl.vertexAttribPointer(0, 2, gl.FLOAT, false, 8 * Float32Array.BYTES_PER_ELEMENT, 6 * Float32Array.BYTES_PER_ELEMENT);
...
export function renderText(text, color, letterHeightPixels = 50) {
    shader.bind();
    gl.bindVertexArray(vao);
